    ...
    <>
      <header style={{ paddingLeft: "1%" }}>
        <h1>
          ...
          <span class="text-green">SillyGoose</span>(){"{"}
        </h1>
        <ul style={{ fontSize: 28 }}>
          {" "}
          <span class="text-orange">public link</span> ={" "}
          <a href="../../">
            <span class="link-blue">[Go Home]</span>
          </a>
          ;
          <br />
          <span class="text-orange">public link</span> ={" "}
          <a href="../../dashboard">
            <span class="link-blue">[Go Dashboard]</span>
          </a>
          ;
          <br />
          <span class="text-orange">public link</span> ={" "}
          <a href="../">
            <span class="link-blue">[Go Back]</span>
          </a>
          ;
          <br />
          <span class="text-orange">public link</span> ={" "}
          <a href="../sillygoose">
            <span class="link-blue">[Switch]</span>
          </a>
          ;
          <main style={{ fontSize: 25 }}>
            ...
            <ul>
              ...
              ;
              <br />
              <span class="text-light-blue">String[2]</span>{" "}
              <span class="text-yellow">language</span> ={" "}
              <span class="text-dark-green"> "Java"</span>;
              <br />
              ...
              <span class="text-yellow">language</span> ={" "}
              <span class="text-dark-green"> "JavaScript"</span>;
              <br />
              ...
              <span class="text-yellow">language</span> ={" "}
              <span class="text-dark-green"> "Python"</span>;
            </ul>
          </main>
          {"}"}
        </ul>
