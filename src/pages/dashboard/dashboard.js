  ...
  const loginclick = () => {
    if(window.location.href.toString().includes("#")){
      ...
      if(window.location.href.includes("sillycode.tech")){
        ...
        window.location.href = "https://discord.com/api/oauth2/authorize?client_id=1043950277738385499&redirect_uri=https%3A%2F%2Fsillycode.netlify.app%2F%2Fdashboard&response_type=code&scope=identify%20guilds"
      }else {                                                   
